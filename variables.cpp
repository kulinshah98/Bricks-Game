...
int space_held=0,s_held=0,a_held=0,d_held=0,f_held=0,canon_held=0,red_basket_held=0,green_basket_held=0,width,height, pause_game=0;

float camera_rotation_angle = 90,now=0,prev_space=0,prev_brick=0,zoom_param=1, pan_x=0, pan_y=0, speed = 0.01f;
